...
From <https://link.springer.com/article/10.1245/s10434-020-08235-w>
...
library(survminer) # 生存曲线绘制 Survival curve drawing
library(ggpubr) # 配色 Color matching
library(patchwork) # 图像合并 Image merging
...
# 自定义颜色
# Custom Colors
mycol <- RColorBrewer::brewer.pal(n = max.condsurv + 1, name = 'Set1')
