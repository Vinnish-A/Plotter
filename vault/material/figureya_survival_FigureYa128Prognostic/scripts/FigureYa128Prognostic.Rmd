...
library(survivalROC) # 生存ROC分析包 Survival ROC analysis package
# 设置环境语言为英文，确保报错信息为英文
...
### 输入文件的下载 Download of input files
...
用base plot画图 Drawing plots with base plot
