...
### 先画风险曲线 Draw the risk curve first
...
[bandwidth](https://en.wikipedia.org/wiki/Kernel_density_estimation)is a free parameter that adjusts the smoothness of the kernel density estimation curve, and the larger the bandwidth of the core, the smoother the curve
