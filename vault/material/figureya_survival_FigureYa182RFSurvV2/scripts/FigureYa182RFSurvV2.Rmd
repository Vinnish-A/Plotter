...
From <https://www.frontiersin.org/articles/10.3389/fonc.2020.00595/full>
...
library(survival) # 生存分析包  # Survival analysis package
library(randomForestSRC) # 随机森林包  # Random forest package
library(randomSurvivalForest) # 随机森林包  # Random forest package
...
## 单变量cox模型筛选预后基因 Univariate cox model for screening prognostic genes
...
## 随机森林进一步降维 The random forest further reduces dimensions
...
### 用包里自带的函数直接出图 Use the built-in functions in the package to directly generate the graph
