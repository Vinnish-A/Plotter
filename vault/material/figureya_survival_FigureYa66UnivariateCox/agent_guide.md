# FigureYa66UnivariateCox

## Figure Purpose

This material is for an Agent to learn and reuse the composition pattern of survival figures. The notes stay abstract and avoid relying on the original domain semantics.
