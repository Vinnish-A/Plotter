...
This material is for an Agent to learn and reuse the composition pattern of tree figures. The notes stay abstract and avoid relying on the original domain semantics.
